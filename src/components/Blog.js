        ...
        <div className="carousel-inner">
          <div className="item active">
           ...
           {/* <div className="item">
            ...
            <div>
              <h1>Founder's Day</h1>
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Odio odit aperiam officiis repudiandae quo ipsa,
                accusamus omnis quaerat? Nulla laborum ab est a expedita hic doloribus modi magni fuga asperiores.</p>
              <p className="date">July 24th, 2022</p>
              <a href="#">Apply Now</a>
            </div>
          </div>  */}
